...
$("#list").jqGrid({
            ...
            datatype: 'json',
            mtype: 'POST',
            colNames:['#', 'Эл. адрес','Фамилия','Имя','Отчество','Группа','Книги', 'Статус','Время отправки'],
            colModel :[{name:'id_mail', index:'id_mail', width:20, align:'right', search:false},
			{name:'mail', index:'mail', width:50, align:'left', edittype:"text",searchoptions:{sopt:['bw','eq','ne','cn'],clearSearch:true}},
			{name:'fam', index:'fam', width:50, align:'left', edittype:"text",searchoptions:{sopt:['bw','eq','ne','cn'],clearSearch:true}},
