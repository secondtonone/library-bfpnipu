...
<form id="ppl">
	...
	<div class="field">
    	...
    	<div class="field">
		<label>Электронная почта:</label><div class="input"><input type="mail" id="email" maxlength="35" placeholder="Введите адрес электронной почты" title="Например: example@mymail.ru" value="<?php echo $_SESSION["e_mail"]; ?>"></div>
	</div>
